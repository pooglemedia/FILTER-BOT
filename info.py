...
API_ID = int(environ.get('API_ID', '20130385'))
API_HASH = environ.get('API_HASH', '5e98c978eca9665c9938af81db323480')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5767034242').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-2545507107'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-2603726473').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-2603726473') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '5767034242')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://praveensasi0123:Zw1pgy8ew7icwWen@cluster0.ycp7q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
